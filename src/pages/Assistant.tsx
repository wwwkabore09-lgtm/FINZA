...
export function Assistant() {
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] flex-col sm:h-[calc(100vh-180px)]">
      <div>
      ...
      <div ref={scrollRef} className="mt-4 flex-1 space-y-4 overflow-y-auto rounded-2xl border border-slate-200 bg-white p-4">
        {messages.length === 0 ? (
