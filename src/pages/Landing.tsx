...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Finza est en cours de développement. Les premières fonctionnalités présentées ici (comptes, budgets, objectifs) sont accessibles gratuitement pendant cette phase.",
  },
  {
