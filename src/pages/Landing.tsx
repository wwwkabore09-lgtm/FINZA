...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Les fonctionnalités de base (comptes, transactions) sont gratuites. Des forfaits payants débloquent des fonctionnalités supplémentaires comme les budgets avancés et le suivi des dettes.",
  },
  {
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-slate-600">
              Les comptes et transactions sont gratuits. Ces formules débloquent des
