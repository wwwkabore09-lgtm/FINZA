-- Subscriptions: one active/pending plan per household, paid via SasPay
...
create unique index subscriptions_saspay_session_id_idx on subscriptions (saspay_session_id)
  where saspay_session_id is not null;
